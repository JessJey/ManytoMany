...
public class RuoloServiceImpl implements RuoloService {
		...
		try {
			...
			if (!utenteDAO.findAllByRuolo(ruoloInstance).isEmpty()) {
				throw new RuntimeException(
						"Impossibile rimuovere: il ruolo specificato risulta ancora associato con utenti");
			}
	...
	@Override
	public List<Ruolo> listDescrizioneRuoloUtenti() throws Exception {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return ruoloDAO.listaDescrizioneRuoliConUtenti();
